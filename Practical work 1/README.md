...
![protocol of comunication](https://github.com/samuelreboucas07/Sistemas-distribu-dos/blob/Atividade-pratica-1/Practical%20work%201/imgs/protocol.png)
...
1. File request present in cache memory:
   ...
   ![execution flow, file in cache](https://github.com/samuelreboucas07/Sistemas-distribu-dos/blob/Atividade-pratica-1/Practical%20work%201/imgs/req_file_1.png)
...
2. File request missing from cache memory:
   ...
   Starting from the previous situation, where the server receives information from the cache memory that the requested file is not present, we have the following flow:
    ...
    ![execution flow, file out of cache](https://github.com/samuelreboucas07/Sistemas-distribu-dos/blob/Atividade-pratica-1/Practical%20work%201/imgs/req_file_2.png)
...
3. Request for list of files present in cache memory:
   ...
   ![execution flow, file listing](https://github.com/samuelreboucas07/Sistemas-distribu-dos/blob/Atividade-pratica-1/Practical%20work%201/imgs/list_files.png)
...
3. Request for listing of files in the cache memory:
   ...
   ![list files](https://github.com/samuelreboucas07/Sistemas-distribu-dos/blob/Atividade-pratica-1/Practical%20work%201/imgs/list_files.gif)
