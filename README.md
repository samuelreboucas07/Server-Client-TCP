...
![protocol of comunication](https://github.com/samuelreboucas07/Server-Client-TCP/blob/master/imgs/protocol.png)
...
1. File request present in cache memory:
   ...
   ![execution flow, file in cache](https://github.com/samuelreboucas07/Server-Client-TCP/blob/master/imgs/req_file_1.png)
...
2. File request missing from cache memory:
   ...
   Starting from the previous situation, where the server receives information from the cache memory that the requested file is not present, we have the following flow:
    ...
    ![execution flow, file out of cache](https://github.com/samuelreboucas07/Server-Client-TCP/blob/master/imgs/req_file_2.png)
...
3. Request for list of files present in cache memory:
   ...
   ![execution flow, file listing](https://github.com/samuelreboucas07/Server-Client-TCP/blob/master/imgs/list_files.png)
...
1. Server startup and file request out of cache:
   ...
   ![Server and cache miss](https://github.com/samuelreboucas07/Server-Client-TCP/blob/master/imgs/cache_miss.gif)

2. Server startup and request for file in cache memory:

   ![server and cache hit](https://github.com/samuelreboucas07/Server-Client-TCP/blob/master/imgs/cache_hit.gif)

3. Request for listing of files in the cache memory:

   ![list files](https://github.com/samuelreboucas07/Server-Client-TCP/blob/master/imgs/list_files.gif)
